package org.example.authexample.security.jwt;
...
import org.example.authexample.security.CustomUserDetails;
import org.example.authexample.security.CustomUserService;
    ...
    private String extractJwtFromCookies(HttpServletRequest request) {
        ...
        if (cookies != null) {
            ...
            return Arrays.stream(cookies)
                    .filter(cookie -> "jwt-auth-token".equals(cookie.getName()))
                    .findFirst()
                    .map(Cookie::getValue)
                    .orElse(null);
        }
